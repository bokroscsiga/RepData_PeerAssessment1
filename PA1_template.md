...
## [1] 10766.19
```
The above values are almost identical to the previous case with NAs. The only impact of inputing missing data on the estimates of the total daily number of steps is that the median is increased a small amount.
